...
const [contractRaw, analytics, finalCalculator, weightedCalculator] = await Promise.all([
...
const expectedBatch = 'site-review-20260722-fullcycle';
...
assert.equal(contract.schema_version, 'analytics_event_contract.v2');
